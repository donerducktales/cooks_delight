      ...
      <main className={`flex flex-col justify-between items-center min-h-screen w-full bg-[#F0EBE1] ${'main'}`}>
         ...
         <section className={`flex flex-col lg:flex-row justify-between mt-16 mb-16 max-[560px]:mt-8 gap-9 max-[560px]:gap-4 ${'heroSection'}`}>
            <div className={`max-w-[648px] ${'heroSectionHeadline'}`}>
               <p className={`text-[5rem] max-[560px]:text-5xl font-extrabold uppercase text-[#262522] text-start ${montserrat.className}`}>
            ...
            <div className={`flex flex-col gap-10 items-start justify-center max-w-[648px] ${'heroSectionTextNdButton'} ${roboto.className}`}>
               <p className={`text-xl text-start max-w-[648px]`}>
               ...
               <button className={`w-40 h-9 rounded-3xl bg-[#F29C33] text-[#262522] text-sm uppercase font-medium`}>
                  explore recipes
               </button>
            </div>
         </section>
